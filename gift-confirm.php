<?php 
    ...
    switch( $_SESSION['lstgift'][$_SESSION['countspin']]){
    ...
    <div class="container">
        ...
        <form action="" id="spinform">
            <div class="draw">
                ...
                <div class="mb-3 mt-3 text-center" style="margin-top: 85%;">
            ...
            <div id="nckd">
                <?php if( $_SESSION['lstgift'][$_SESSION['countspin']]==1) echo "<img src='image/noi_chien/nckd.png' alt='' id='nckd'>"; ?>
            </div>
        </form>
